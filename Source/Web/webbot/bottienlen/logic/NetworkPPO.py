...
class ActionNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha, fc1_dims = 512, fc2_dims = 256, chkpt_dir = "tmp/tienlen/ppo"):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, n_actions, alpha, fc1_dims = 512, fc2_dim2 = 256, chkpt_dir = "tmp/tienlen/ppo"):
