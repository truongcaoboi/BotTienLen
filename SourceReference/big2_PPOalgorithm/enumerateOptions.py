...
def eleventCardOptions(handOptions, prevHand=[],prevType = 0):
    pass

def tenCardOptions(handOptions, prevHand=[],prevType = 0):
    pass

def nineCardOptions(handOptions, prevHand=[],prevType = 0):
    pass

def eightCardOptions(handOptions, prevHand=[],prevType = 0):
    pass

def sevenCardOptions(handOptions, prevHand=[],prevType = 0):
    pass
